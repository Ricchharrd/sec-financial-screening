...
def write_screening_workbook(summary_rows: list[dict], flag_rows: list[dict], note_rows: list[dict], output_path: Path):
    try:
    ...
    append_sheet(
        summary_ws,
        summary_rows,
        ratio_columns={"Debt Ratio", "Operating Margin", "Net Margin", "ROA"},
        amount_columns={
            "Revenue",
            "Operating Income",
            "Net Income",
...
def workbook_bytes(summary_rows: list[dict], flag_rows: list[dict], note_rows: list[dict], error_rows: list[dict]) -> bytes:
    import tempfile
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        write_screening_workbook(summary_rows, flag_rows, note_rows, output_path)
